...
export default function FloatingWhatsApp() {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      style={{ zIndex: 9999 }}
      className="group fixed bottom-20 right-4 lg:bottom-6 lg:right-6 flex items-center gap-2 rounded-full bg-[#25D366] text-white px-3.5 py-3.5 shadow-[0_6px_24px_rgba(37,211,102,0.45)] transition-all duration-300 hover:px-5"
    >
      <svg viewBox="0 0 24 24" className="h-7 w-7 fill-current flex-shrink-0" aria-hidden="true">
      ...
      <span className="max-w-0 overflow-hidden whitespace-nowrap text-sm font-semibold transition-all duration-300 group-hover:max-w-[160px] group-hover:ml-1 group-hover:mr-1">
        Chat with us
      </span>
