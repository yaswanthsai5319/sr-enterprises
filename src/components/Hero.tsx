...
export default function Hero() {
  ...
  const trustItems = [
    { icon: "📦", label: tt("products") },
    { icon: "🚚", label: tt("delivery") },
    { icon: "🖨️", label: tt("print") },
    { icon: "🏭", label: tt("machinery") },
  ];
  ...
  return (
    <>
      <section
        id="home"
        className="relative min-h-dvh overflow-hidden bg-[var(--forest-dark)]"
      >
        ...
        {/* Forest-green semi-transparent overlays */}
        <div className="absolute inset-0 bg-[var(--forest-dark)]/80" />
        <div className="absolute inset-0 bg-gradient-to-r from-[var(--forest-dark)]/95 via-[var(--forest-dark)]/70 to-[var(--forest-dark)]/40" />
        <div className="absolute inset-0 bg-gradient-to-t from-[var(--forest-dark)] via-transparent to-[var(--forest-dark)]/40" />

        <div className="relative section-max px-5 sm:px-8 flex flex-col justify-end min-h-dvh pb-28 pt-36 lg:pb-40 lg:pt-40">
          <div className="max-w-xl">
            ...
            >
              ...
              >
                <span className="h-1.5 w-1.5 rounded-full bg-[var(--forest-accent)]" />
                {t("subtitle")}
              </span>
            </motion.div>
            ...
            <motion.h1
              ...
              className="mt-6 font-display text-4xl font-semibold leading-[1.08] text-white sm:text-5xl lg:text-6xl xl:text-7xl drop-shadow-[0_2px_10px_rgba(0,0,0,0.4)]"
            >
              {t("title")}
            </motion.h1>
            ...
            <motion.p
              ...
              className="mt-4 text-sm font-medium uppercase tracking-widest text-[var(--amber)]"
            >
            ...
            <motion.p
              ...
              className="mt-5 text-base leading-relaxed text-white/85 sm:text-lg max-w-md"
            >
              {t("description")}
            </motion.p>
            ...
            >
              <a
                ...
                className="btn btn-amber min-h-[52px] text-base"
              >
              ...
              <a
                ...
                className="btn btn-outline-white min-h-[52px] text-base"
              >
                📞 {t("call")}
              </a>
            </motion.div>
      ...
      {/* Trust bar */}
      <div className="bg-[var(--forest-mid)] text-white">
        <div className="section-max px-5 sm:px-8 py-6">
